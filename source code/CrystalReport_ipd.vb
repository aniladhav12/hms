...
Public Class CrystalReport_ipd
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DK_Hospital.CrystalReport_ipd.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport_ipd
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport_ipd = New CrystalReport_ipd()
        rpt.Site = Me.Site
        Return rpt
    End Function
