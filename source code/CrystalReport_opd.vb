...
Public Class CrystalReport_opd
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DK_Hospital.CrystalReport_opd.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport_opd
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport_opd = New CrystalReport_opd()
        rpt.Site = Me.Site
        Return rpt
    End Function
